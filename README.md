...
Este proyecto utiliza Google Maps API para la búsqueda de ubicaciones. Para configurarlo:

1. Abre o crea el archivo `.env` en la raíz del proyecto
2. Agrega tu clave de API de Google Maps:

```env
VITE_GOOGLE_MAPS_API_KEY=tu-clave-api-aqui
```

3. Asegúrate de tener habilitadas las siguientes APIs en tu proyecto de Google Cloud Console:
   - **Maps JavaScript API**
   - **Places API**
